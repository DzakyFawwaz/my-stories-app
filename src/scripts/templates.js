...
export function generateCommentsListEmptyTemplate() {
  return `
    <div id="story-detail-comments-list-empty" class="report-detail__comments-list__empty">
...
export function generateCommentsListErrorTemplate(message) {
  return `
    <div id="story-detail-comments-list-error" class="report-detail__comments-list__error">
